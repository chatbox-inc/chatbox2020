    ...
    <div class="container mx-auto text-black px-5">
      <div class="lg:flex lg:space-x-12">
        <div class="w-full lg:w-1/2">
          ...
          <div
            class="marked leading-7 lg:leading-8 mt-4 lg:mt-8 tracking-wider text-sm lg:text-base"
...
chatbox
の技術顧問サービスは、制作現場の業務効率化を強力に支援します。\n最新技術のレクチャーやコードレビューなどといった日々の業務改善から、
制作フローの見直しやプロジェクトの進行管理、\n教育プロセスの改善といった長期的な改善まで、
技術に関する様々な課題解決のサポートを、複数のWeb制作現場で実施しています。\n日々複雑化するWeb制作の技術の中で、常に「Webのこれから」を求め続けることの出来る
未来志向の制作現場づくりを chatbox がサポートします。\n Lec Cafe
のイベントとして、 Nuxt.js と Firebase で作るTODOアプリ
を公開しました。\nNuxt.js と Firebase を利用して TODO アプリ
を構築するためのフローが学べるハンズオン形式の講座となっています。\nJavaScript
のフレームワークを利用した、モダンな開発フローにご興味の方は是非ご参加ください。
イベントの詳細・お申し込みは connpass
にて受付させていただいております。https://leccafe.connpass.com/event/183518/
